...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "do_notHaveAccount": MessageLookupByLibrary.simpleMessage("ليس لديك حساب"),
    ...
    "fristName": MessageLookupByLibrary.simpleMessage("الاسم الأول"),
    ...
    "phoneNumberOnlyNums": MessageLookupByLibrary.simpleMessage(
      "رقم االهاتف يجب ان يكون مكون من ارقام فقط",
    ),
    ...
    "reportingCybercrimes": MessageLookupByLibrary.simpleMessage(
      "التبليغ عن الجرائم الالكترونيه",
    ),
    ...
    "tip10": MessageLookupByLibrary.simpleMessage(
      "قم بتحديث نظام التشغيل والتطبيقات لتجنب الثغرات الأمنية.",
    ),
    "tip2": MessageLookupByLibrary.simpleMessage(
      "تجنّب الضغط على الروابط المشبوهة أو المرسلة من مصادر غير موثوقة.",
    ),
    "tip3": MessageLookupByLibrary.simpleMessage(
      "تأكد من أن المواقع التي تزورها تبدأ بـ HTTPS قبل إدخال أي بيانات حساسة.",
    ),
    "tip4": MessageLookupByLibrary.simpleMessage(
      "استخدم برامج الحماية وقم بتحديثها بانتظام للحماية من الفيروسات والاختراق.",
    ),
    "tip5": MessageLookupByLibrary.simpleMessage(
      "استخدم شبكة VPN موثوقة عند الاتصال بشبكات عامة أو مفتوحة.",
    ),
    "tip6": MessageLookupByLibrary.simpleMessage(
      "اختر كلمات مرور قوية وطويلة ولا تستخدم نفس كلمة المرور لأكثر من حساب.",
    ),
    "tip7": MessageLookupByLibrary.simpleMessage(
      "احتفظ بنسخ احتياطية من بياناتك المهمة في مكان آمن.",
    ),
    "tip8": MessageLookupByLibrary.simpleMessage(
      "بلّغ فوراً عن أي محاولة احتيال أو تهديد إلكتروني.",
    ),
