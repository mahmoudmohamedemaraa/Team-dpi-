          ...
          child: ListView(
            children: [
                  ...
                  Row(
                    children: [
                      CircleAvatar(
                        ...
                        radius: 30,
                        child: Icon(Icons.person,size: 30,color: AppTheme.lightGrey,),
                      ),
                      SizedBox(width: 16,),
                      Column(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Expanded(child: WidgetQuickOptions(icon: Icons.receipt_long, text: " بلاغاتي",)),
                  SizedBox(width: 16,),
                  Expanded(child: WidgetQuickOptions(icon: Icons.security, text: "نصائح امنيه",)),
                ],
              ),
              SizedBox(height: 8,),
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Expanded(child: WidgetQuickOptions(icon: Icons.emoji_events, text: "المكافات",)),
                  SizedBox(width: 16,),
                  Expanded(child: WidgetQuickOptions(icon: Icons.phone, text: " ارقام طوارئ",)),
                ],
              ),
              SizedBox(height: 32,),
              WidgetAwarenessCard(
